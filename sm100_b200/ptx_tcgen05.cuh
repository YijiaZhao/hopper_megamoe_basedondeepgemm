...
// NVFP4: E2M1 x E2M1 with UE4M3 scales per 16 elements
...
struct SM100_MMA_MXF4NVF4_BLOCK32_2x1SM_SS {
    CUTLASS_DEVICE static void
    fma(uint64_t const& desc_a, uint64_t const& desc_b, uint32_t const& tmem_c, uint32_t const& scale_c,
