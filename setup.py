...
sources = ['csrc/python_api.cpp', 'csrc/mega_frontend.cu', 'csrc/fable_frontend.cu', 'csrc/router_frontend_kf.cu', 'csrc/router_frontend_topk8_kf.cu', 'csrc/qoq_router_frontend_kf.cu', 'csrc/router_frontend_tc.cu']
build_include_dirs = [
    f'{CUDA_HOME}/include',
