...
// Default (python wrapper, DG_FE_TINYM_MMA=auto): m <= 2 rows -> cc on the auto grid with
// DG_FE_ROUTER_L2_PERSIST=1; otherwise mma = swapab, wlayout = fragment (the wrapper permutes a row-major
