...
| 8x B200 (SM100, 1965 MHz) | W-MXFP4xA-FP8 (optimised upstream kernel) / W4A4 MXFP4 / W4A4 NVFP4 (new kernels) (`sm100_b200/`, on AichenF DeepGEMM `megamoe_nvfp4_dev`) | 37.5 / 42.6 / 49.3 / 55.2 (FP8 act), 35.6 / 41.3 / 45.8 / 52.5 (MXFP4), 33.9 / 41.5 / 47.4 / 52.7 (NVFP4) | [docs/B200_MEGAMOE_RESULTS.md](docs/B200_MEGAMOE_RESULTS.md) |
